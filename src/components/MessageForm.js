        ...
        <>
                    ...
                    messages.map(({_id: date, messagesByDate}, idx)=> (
                        <div key={idx}>
                            ...
                            {messagesByDate?.map(({content, time, from: sender}, msgIdx) => {
                               return <div className={sender?.email === user?.email ? "message" : "incoming-message "} key={msgIdx}>
            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    ...
                    <Col md={1}>
                        <Button variant="primary" type="submit" style={{width: "100%"}} disabled = {!user}>
