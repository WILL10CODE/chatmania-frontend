...
export default function Sidebar() {
    ...
    function joinRoom(room, isPublic = true) {
      ...
      dispatch(resetNotifications(room)) //dispatch for notifications
  ...
  return (
    <>
        ...
        {members.map((member, id) => {
          return <ListGroup.Item key = {id} onClick ={()=>handlePrivateMemberMsg(member)} active={privateMemberMsg?._id === member._id} disabled ={member._id === user._id} style = {{cursor: "pointer", display:"flex", justifyContent: "space-between" }}>
              <Row>
